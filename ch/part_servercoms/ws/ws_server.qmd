# Servidor WebSockets con JavaScript {#sec-ws-server}
...
Un servidor echo completo que devuelve cualquier mensaje que recibe se vería así (la opción `path: '/echo'` hace que solo se acepten conexiones WebSocket en la ruta `/echo`, que es la que usa el cliente de @sec-ws-client):
