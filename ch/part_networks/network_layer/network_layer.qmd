...
Por último, NAT es una función que involucra ambos planos (lo veremos después). Al principio operaba sólo en el plano de control, tomando un tiempo significativo. En la actualidad, las sesiones se gestionan en el plano de control y la traducción por paquete en hardware especializado en el plano de datos.
...
```
Ejemplo de NAT con dos Host que se comunican con un servidor web utilizando una única IP pública.
:::
