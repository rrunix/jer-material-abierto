...
4. El switch recibe la respuesta de C desde el puerto 3. Asocia la dirección MAC de C al puerto 3. Reenvía la respuesta a A, que ya sabe que está en el 1.
5. A envía el mensaje con destinatario la dirección MAC de C.
6. El switch recibe el mensaje, busca en su tabla y comprueba que la dirección MAC coincide con el puerto 3 y lo reenvía.
...
| **Transceptores** | Conectividad modular | SFP/SFP+/QSFP, intercambiables | Flexibilidad en tipos de conexión |
...
La evolución de Ethernet ha sido extraordinaria, desde el Ethernet original sobre cable coaxial y 10Base-T que maneja 10 Mbps sobre cable trenzado CAT3/5, evolucionando hasta 10GBase-T con 10 Gbps sobre CAT6A/7. En contextos intensivos, o en nodos centrales, se cuenta con implementaciones de mayor velocidad. Todo esto se ha conseguido a través de diferentes estándares de modelos físicos y la mejora de rendimiento en el hardware. También se ha vuelto posible combinar la transmisión de datos y energía eléctrica por un mismo cable, simplificando los dispositivos de red.
...
Al igual que en Ethernet, la evolución de Wi-Fi ha sido enorme. El estándar original 802.11 (1997) ofrecía 2 Mbps; 802.11n (Wi-Fi 4) alcanzó velocidades de hasta 600 Mbps, mientras que Wi-Fi 7 (802.11be) promete hasta 46 Gbps. Las mejoras se han enfocado en técnicas para reducir interferencias entre redes y colisiones entre dispositivos, y la inclusión de más bandas:

- 2.4 GHz: mayor alcance y penetración, pero menor velocidad.
- 5 GHz: mayor velocidad pero menor alcance.
- 6 GHz: mayor velocidad y menos interferencias, aunque requiere de hardware específico y tiene el menor alcance de las tres bandas.
